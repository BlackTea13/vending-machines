...
class VendingMachine(Base):
    ...
    products = relationship(
        "MachineStock", back_populates="vending_info", cascade="all,delete", lazy=True)
    ...
    def increase_product_quantity_by_id(self, session: Session, product_id: str, quantity: str) -> Result:
        ...
        session.commit()
        return Result.success(f'product quantity successfully changed from'
                              f' {quantity_old} to {listing.quantity}', listing)
